...
public class ExpandableTextView extends LinearLayout implements OnClickListener {
	...
	private int mMaxCollapsedLines = 3; // The default number of lines;
	...
	public void onClick(View v) {
		//Only complete onClick action if we havent clicked on a link
		if (mTv.getSelectionStart() == -1 && mTv.getSelectionEnd() == -1) {
