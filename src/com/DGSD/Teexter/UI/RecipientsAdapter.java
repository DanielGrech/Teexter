...
public class RecipientsAdapter extends ResourceCursorAdapter {
	...
	public final CharSequence convertToString(Cursor cursor) {
		...
		String nameAndNumber = ContactUtils.formatNameAndNumber(name, number);
	...
	public final void bindView(View view, Context context, Cursor cursor) {
		...
		number.setText(PhoneNumberUtils.formatNumber(cursor.getString(NUMBER_INDEX)));
	}
	...
	public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
		...
		Uri uri = Phone.CONTENT_FILTER_URI.buildUpon().appendPath(cons)
				.appendQueryParameter(DataUsageFeedback.USAGE_TYPE, DataUsageFeedback.USAGE_TYPE_SHORT_TEXT).build();
		/*
		 ...
		 */
		Cursor phoneCursor = mContentResolver.query(uri, PROJECTION_PHONE, null, // selection,
				null, null);
